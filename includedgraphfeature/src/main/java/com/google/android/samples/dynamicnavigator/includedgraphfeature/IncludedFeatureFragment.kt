...
import com.google.android.samples.dynamicnavigator.includedgraphfeature.IncludedFeatureFragmentDirections.Companion.actionFeatureIncludedToFeatureFragment
...
class IncludedFeatureFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.btnGo).setOnClickListener {
            findNavController().navigate(actionFeatureIncludedToFeatureFragment())
        }
    }
